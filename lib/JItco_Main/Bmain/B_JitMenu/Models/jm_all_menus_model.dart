class JmAllMenusModel {
  ...
  factory JmAllMenusModel.fromJson(Map<String, dynamic> json) {
    return JmAllMenusModel(
      ...
      menus: json['menus'] == null
          ? []
          : List<Allmenu>.from(json['menus']!.map((x) => Allmenu.fromJson(x))),
    );
  }
...
class Allmenu {
  ...
  factory Allmenu.fromJson(Map<String, dynamic> json) => Allmenu(
    ...
    statusList: json["statusList"] == null
        ? []
        : List<dynamic>.from(json["statusList"]!.map((x) => x)),
    source: json["source"] ?? "",
