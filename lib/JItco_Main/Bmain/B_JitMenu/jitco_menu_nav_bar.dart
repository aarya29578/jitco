...
// import 'package:jitco_app/JItco_Main/Bmain/B_JitMenu/Screens/b_JM_Category/jm_category_screen.dart';
// import 'package:jitco_app/JItco_Main/Bmain/B_JitMenu/Screens/a_JM_Home/jm_home_screen.dart';
// import 'package:jitco_app/JItco_Main/Bmain/B_JitMenu/Screens/c_JM_Product_Screen/jm_all_product_screen.dart';
// import 'package:jitco_app/JItco_Main/Bmain/B_JitMenu/Screens/d_JM_Cart_Screen/jm_cart_screen.dart';
// import 'package:jitco_app/JItco_Main/Bmain/B_JitMenu/Widgets/jm_cart_badge_icon.dart';

// class JitcoMenuNavBar extends StatefulWidget {
//   final int initialIndex;

//   const JitcoMenuNavBar({super.key, this.initialIndex = 0});

//   @override
//   State<JitcoMenuNavBar> createState() => JitcoMenuNavBarState();
// }

// class JitcoMenuNavBarState extends State<JitcoMenuNavBar> {
//   // int _currentIndex = 0;
//   final JmBottomNavController navController = Get.put(JmBottomNavController());
...
//             children: [
//               _buildNavigator(0, JMHomeScreen()),
//               _buildNavigator(1, JMCategoryScreen()),
//               _buildNavigator(2, JMAllProductsScreen()),
//               _buildNavigator(3, JmCartScreen()),
//             ],
//           ),
...
//   //       ),
//   //       BottomNavigationBarItem(
//   //         icon: JmCartBadgeIcon(isActive: false, nonActiveColor: Colors.grey),
//   //         activeIcon: JmCartBadgeIcon(
//   //           isActive: true,
...
//           ),
//           BottomNavigationBarItem(
//             icon: JmCartBadgeIcon(isActive: false),
//             activeIcon: JmCartBadgeIcon(isActive: true),
//             label: 'Cart',
//           ),
//         ],
//       ),
...
//       SnackBar(
//         content: const Text(
//           'JIT Menu - Press back again to exit',
//           textAlign: TextAlign.center,
...
//                     label: "Products",
//                   ),
//                   _buildNavItemCart(index: 3, label: "Menu"),
//                 ],
//               ),
//             ),
//           ),
...
class JitcoMenuNavBar extends StatefulWidget {
  ...
  const JitcoMenuNavBar({super.key, this.initialIndex = 1});
...
class JitcoMenuNavBarState extends State<JitcoMenuNavBar> {
  // int _currentIndex = 0;
  final JmBottomNavController bottomNavController = Get.put(
    JmBottomNavController(),
  );
  DateTime? _lastBackPressTime; // Track last back press time
        ...
        () => Scaffold(
          body: IndexedStack(
            ...
            children: [
              ...
              _buildNavigator(1, JMHomeScreen()),
              _buildNavigator(2, JMCategoryScreen()),
              _buildNavigator(3, JMAllProductsScreen()),
              _buildNavigator(4, JmCartScreen()),
            ],
          ),
          bottomNavigationBar: _buildBottomNavigationBar(),
        ),
