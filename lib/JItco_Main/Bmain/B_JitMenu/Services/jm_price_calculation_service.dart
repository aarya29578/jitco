...
class JmPriceCalculationService extends GetxService {
  static JmPriceCalculationService get to => Get.find();
  ...
  Map<String, double> calculateCartTotals({
    required List<JmCartItem> cartItems,
