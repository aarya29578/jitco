...
import 'package:jitco_app/JItco_Main/Bmain/B_JitMenu/Screens/d_JM_Cart_Screen/jm_menu_summary_screen.dart';
...
// import 'package:jitco_app/screens/Jitco_Supply_Home/D_Cart%20and%20summary/checkout_Screen.dart';
...
class JmCartScreen extends StatefulWidget {
  const JmCartScreen({super.key});

  @override
  State<JmCartScreen> createState() => _JmCartScreenState();
}

class _JmCartScreenState extends State<JmCartScreen> {
  ...
  Future<void> _fetchIdFromWarehouse() async {
    try {
      final outletResponse = await apiService.getUserOutlet();
      ...
      if (outletResponse['success'] == true && outletResponse['data'] is List) {
        ...
        final result = await apiService.getWarehouseIdByCity(
          page: 1,
          limit: 1,
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${cartController.totalItems} ${cartController.totalItems == 1 ? 'item' : 'items'} in your menu',
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                // Get.offAll(
                //   () => JitcoMenuNavBar(initialIndex: 0),
  ...
  Widget _buildCartItemNew(JmCartItem item) {
    ...
    final totalWithGST =
        (calculatedPrice * item.quantity) + (gstAmount * item.quantity);
  ...
  void _showDeleteDialog(JmCartItem item) {
    showDialog(
