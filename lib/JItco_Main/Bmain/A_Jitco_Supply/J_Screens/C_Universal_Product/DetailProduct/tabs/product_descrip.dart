...
class ProductDescrip extends StatefulWidget {
  final Map<String, dynamic>? productData;
  const ProductDescrip({super.key, required this.productData});

  @override
  State<ProductDescrip> createState() => _ProductDescripState();
}

class _ProductDescripState extends State<ProductDescrip> {
        ...
        child: Column(
          ...
          children: [
            ...
            if (_getUSP().isNotEmpty &&
                _getUSP() != 'No product information available') ...[
              TabsHeader(tabsHeader: 'Product USP'),
              10.heightBox,
              Padding(
            ...
            if (_getIngredients().isNotEmpty &&
                _getIngredients() !=
                    'No ingredients information available') ...[
              TabsHeader(tabsHeader: 'Ingredients / Composition'),
              10.heightBox,
              Padding(
                padding: const EdgeInsets.only(left: 10),
                child: Text(
            ...
            if (_getStorageInstructions().isNotEmpty &&
                _getStorageInstructions() !=
                    'No storage instructions available') ...[
              TabsHeader(tabsHeader: 'Storage Instructions'),
              10.heightBox,
              Padding(
                padding: const EdgeInsets.only(left: 10),
                child: Text(
