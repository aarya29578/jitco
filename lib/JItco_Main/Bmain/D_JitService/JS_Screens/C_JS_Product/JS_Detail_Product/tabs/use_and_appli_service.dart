...
class UseAndAppliService extends StatefulWidget {
  final Map<String, dynamic>? productData;
  const UseAndAppliService({super.key, required this.productData});

  @override
  State<UseAndAppliService> createState() => _UseAndAppliServiceState();
}

class _UseAndAppliServiceState extends State<UseAndAppliService> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.productData != null)
                TabsHeader(tabsHeader: 'Compliance & Maintenance Service'),
              10.heightBox,
              Padding(
