...
class JsOrderScreen extends StatefulWidget {
  const JsOrderScreen({super.key});

  @override
  State<JsOrderScreen> createState() => _JsOrderScreenState();
}

class _JsOrderScreenState extends State<JsOrderScreen> {
  final JsOrderController orderController = Get.find<JsOrderController>();
  ...
  List<JsOrder> get filteredOrders {
  ...
  Widget _buildOrderCard(JsOrder order) {
    return Card(
      color: Colors.white,
