...
class JsOrderModel {
  ...
  factory JsOrderModel.fromJson(Map<String, dynamic> json) {
    final product = json['product'] as Map<String, dynamic>?;
...
class JsOrder {
  ...
  factory JsOrder.fromJson(Map<String, dynamic> json) {
    final items = (json['items'] as List<dynamic>)
        .map((item) => JsOrderModel.fromJson(item as Map<String, dynamic>))
        .toList();
  ...
  JsOrderModel? get firstItem => items.isNotEmpty ? items[0] : null;
}
