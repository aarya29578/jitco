class JsQuatationModel {
  final bool? status;
  final List<Quote>? quote;
  JsQuatationModel({this.status, this.quote});

  factory JsQuatationModel.fromJson(Map<String, dynamic> json) {
    return JsQuatationModel(
