...
import 'package:jitco_app/JItco_Main/Bmain/C_JitLiquor/JL_Screens/A_Home%20and%20Drawer/JL_Drawer/JL_order_detail_screen.dart';
...
class JlOrderScreen extends StatefulWidget {
  const JlOrderScreen({super.key});

  @override
  State<JlOrderScreen> createState() => _JlOrderScreenState();
}

class _JlOrderScreenState extends State<JlOrderScreen> {
  final JlOrderController orderController = Get.find<JlOrderController>();
  ...
  List<JlOrder> get filteredOrders {
  ...
  Widget _buildOrderCard(JlOrder order) {
    return Card(
      color: Colors.white,
                  ...
                  .map(
                    (item) => ListTile(
                      ...
                      trailing: Column(
                        ...
                        children: [
                          "₹${item.priceTotal!.toStringAsFixed(2)}".text
                              .size(14)
                              .fontWeight(FontWeight.w500)
                              .make(),
                          // 1.heightBox,
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () {
                        Get.to(() => JLOrderDetailScreen(orderId: order.id));
                      },
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(color: Colors.orange.shade700),
                      ),
